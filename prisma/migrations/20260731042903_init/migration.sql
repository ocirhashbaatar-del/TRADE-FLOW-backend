-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'MANAGER', 'VENDOR', 'CUSTOMER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER', 'INVENTORY', 'SHIPMENT', 'SYSTEM', 'MESSAGE');
...
CREATE TABLE "User" (
    ...
    "tenant" TEXT NOT NULL DEFAULT 'TradeFlow',
